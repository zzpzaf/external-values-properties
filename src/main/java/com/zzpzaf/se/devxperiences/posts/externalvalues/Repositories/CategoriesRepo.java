...
import com.zzpzaf.se.devxperiences.posts.externalvalues.DataObjects.Category;
import com.zzpzaf.se.devxperiences.posts.externalvalues.DataObjects.CategoryDTO;
...
public class CategoriesRepo {
    ...
    @Autowired 
    DataBaseObjectNames dbObjNames;    
    ...
    public List<Category> getAllCategories() {
        // CATEGORIES_TABLE = env.getProperty("set1.categories-table");
        CATEGORIES_TABLE = dbObjNames.getCategoriesTable();
